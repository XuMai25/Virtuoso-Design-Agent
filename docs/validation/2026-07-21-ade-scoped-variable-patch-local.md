...
- analysis CAS 与 output/spec add-only patch 已在后续本地 Gate 实现，见 [`2026-07-21-ade-setup-patch-local.md`](2026-07-21-ade-setup-patch-local.md)；background exact-history input/result/log manifest 也已完成[本地契约](2026-07-21-ade-background-artifact-manifest-local.md)。两类 patch 的 nics4304 live、真实 netlist 参数核对和有限 corner 规格闭环仍待验证。
