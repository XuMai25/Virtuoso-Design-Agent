...
- VDA 已有 global/test/corner 逐 scope 变量 CAS，以及 analysis CAS + output/spec add-only patch 的本地契约，但尚未 live 验证，也未自动创建完整 testbench、stimulus 或 corner；`ade.run` 仍只执行已有保存状态。详见 [`2026-07-21-ade-scoped-variable-patch-local.md`](2026-07-21-ade-scoped-variable-patch-local.md) 与 [`2026-07-21-ade-setup-patch-local.md`](2026-07-21-ade-setup-patch-local.md)。
