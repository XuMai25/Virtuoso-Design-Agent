...
反相器 L5A
  ...
  -> 通用 topology-delta 契约（add/remove/reconnect 与 NMOS master/CDF 的新 cellview forward→si/Spectre→inverse 已过；exact-state post-save recovery 本地已过、live 故障注入待验证；pin/shape 待 Gate）
