...
反相器 L5A
  ...
  -> active-load + 对称源极退化组合拓扑（OA/si/多分析本地已过；新 cellview live forward/inverse 与逐层 Spectre 待 Gate）
  -> L5B 单模块闭环
