...
反相器 L5A
  ...
  -> 通用 MOS 小信号网络（矩阵、stamp/MNA 数值接缝、独立器件表和首个 exact-geometry 共源 OA/si/DC/AC held-out Gate 已过；源退化与多 MOS 迁移待 Gate）
